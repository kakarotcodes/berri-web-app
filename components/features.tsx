                        ...
                        <CardHeader>
                            <div className="md:p-6">
                                ...
                                <p className="text-muted-foreground mt-3 max-w-sm text-sm">
                                    Monitor your business metrics in real-time with intuitive dashboards. 
                                    Get instant insights into your performance with customizable visualizations.
                                </p>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="group relative shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-br-xl">
                        <CardHeader className="p-6 md:p-12">
                            ...
                            <p className="text-muted-foreground mt-2 max-w-sm text-sm">
                                Process millions of data points in seconds with our optimized infrastructure.
                            </p>
                        </CardHeader>
