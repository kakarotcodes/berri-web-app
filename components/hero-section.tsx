    ...
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-foreground border-b border-white/10 pb-3 text-sm font-medium">Revenue increased by 23% this quarter compared to last year.</div>
                <div className="space-y-3">
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium">$47,892</span>
                            <span className="text-muted-foreground text-xs">This quarter</span>
                        </div>
                        <div className="flex h-5 items-center rounded bg-gradient-to-l from-blue-400 to-purple-600 px-2 text-xs text-white">Q4 2024</div>
                    </div>
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium">$38,901</span>
                            <span className="text-muted-foreground text-xs">Last year</span>
                        </div>
                        <div className="text-foreground bg-muted flex h-5 w-2/3 items-center rounded px-2 text-xs dark:bg-white/20">Q4 2023</div>
                    </div>
                </div>
            </div>
        </div>
