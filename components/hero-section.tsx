              ...
              >
                ...
                <div className="mt-12 flex flex-col gap-4 sm:flex-row sm:justify-center">
                  ...
                  <Button asChild variant="outline" size="lg" className="rounded-full">
                    <a href="https://berri-downloads.s3.ap-south-1.amazonaws.com/releases/stable/berri-1.0.15.dmg" download className="flex items-center gap-2">
              ...
              <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                ...
                {/* {loading ? (
                  ...
                  <> */}
                    ...
                    >
                      <a href="https://berri-downloads.s3.ap-south-1.amazonaws.com/releases/stable/berri-1.0.15.dmg" download>
