// Auth success page - commented out to remove authentication features

// 'use client'

/**
 * Authentication Success Page - Berri Web Application - DISABLED
 *
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center">
        <h1 className="text-2xl font-medium mb-4">Authentication Disabled</h1>
