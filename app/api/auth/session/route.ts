// Auth session routes - commented out to remove authentication features
...
// Get current user session - disabled
export async function GET(request: NextRequest) {
  return NextResponse.json({ user: null, message: 'Authentication disabled' })
}
